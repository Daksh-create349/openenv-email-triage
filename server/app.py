...
# Add a beautiful landing page to the root route
...
def root():
    ...
    <body>
        <div class="card">
            ...
            <p>Enterprise-grade AI email triage environment with SLA awareness,
            sentiment analysis, and deterministic grading. Built for the OpenEnv Hackathon.</p>
            <div class="endpoints">
...
# Define main() for [project.scripts] entrypoint
def main() -> None:
    import uvicorn
